...
--
-- Table structure for table `note_blocks`
--
...
CREATE TABLE `note_blocks` (
  ...
  KEY `idx_note_pos` (`note_id`,`position`),
...
CREATE TABLE `note_comments` (
  ...
  KEY `idx_note_parent` (`note_id`,`parent_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `note_pages_meta`
--

DROP TABLE IF EXISTS `note_pages_meta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `note_pages_meta` (
  `note_id` bigint unsigned NOT NULL,
...
--
-- Table structure for table `note_tag_assignments`
--
...
--
-- Table structure for table `note_tags_catalog`
--

DROP TABLE IF EXISTS `note_tags_catalog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `note_tags_catalog` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `note_template_shares`
--

DROP TABLE IF EXISTS `note_template_shares`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `note_template_shares` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `idx_template_share_user` (`user_id`),
...
--
-- Table structure for table `public_task_hits`
--

DROP TABLE IF EXISTS `public_task_hits`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `public_task_hits` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `token_id` bigint unsigned NOT NULL,
  ...
  CONSTRAINT `fk_task_hits_token` FOREIGN KEY (`token_id`) REFERENCES `public_task_tokens` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6552 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5995 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-12  9:41:41
